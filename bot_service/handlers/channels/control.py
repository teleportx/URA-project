...
channel_menu_text = ('<b>Меню управления каналами.</b>\n'
                     ...
                     'Уведомление о ректальных активностях придет в ваш тг канал.\n\n'
                     'Пусть ваш тг канал станет ещё информативнее, ведь с помощью бота можно добавить тех, '
                     'кто вместе с вами будет уведомлять ваших подписчиков о своих кишечных потугах!')
